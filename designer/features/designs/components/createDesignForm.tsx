...
const DesignForm: React.FC<FormProps> = ({ type, design }) => {
                ...
                <FormField
                    ...
                    render={({ field }) => (
                        <FormItem>
                            ...
                            {field.value && (
                                <div className="mt-2">
                                    <img src={field.value || "/placeholder.svg"} alt="Thumbnail" className="w-32 h-32 object-cover rounded" />
                                </div>
                            )}
                            <FormMessage />
                        </FormItem>
                    ...
                    render={({ field }) => (
                        <FormItem className="flex flex-row items-center justify-between rounded-lg border p-3 shadow-sm">
                            <div className="space-y-0.5">
                                ...
                                <FormDescription>
                                    Do you want to publish this design immediately or save it as a draft?
                                </FormDescription>
                            </div>
                            <FormControl>
                                <Switch
