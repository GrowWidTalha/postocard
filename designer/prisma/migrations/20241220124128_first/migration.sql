-- CreateEnum
CREATE TYPE "UserRole" AS ENUM ('USER', 'ADMIN', 'PRINTING_PROVIDER', 'DESIGNER');

-- CreateEnum
CREATE TYPE "CardStatus" AS ENUM ('PENDING', 'APPROVED', 'DISABLED');

-- CreateEnum
CREATE TYPE "OrderStatus" AS ENUM ('PENDING', 'PROCESSING', 'PRINTED', 'SHIPPED', 'DELIVERED');

-- CreateEnum
CREATE TYPE "PrintStatus" AS ENUM ('PENDING', 'ASSIGNED', 'PRINTED', 'APPROVED', 'SHIPPED');
...
CREATE TABLE "Design" (
    ...
    "designCategoryId" TEXT NOT NULL,
